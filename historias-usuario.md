...
**Scope:** Las 3 historias críticas para el MVP (v0.1)
...
| # | Historia | Razón de criticidad |
|---|---|---|
| 1 | Autenticación corporativa | Bloqueante absoluto — sin auth no hay acceso al producto |
| 2 | Gestión de tickets (Kanban) | Core del MVP — es el producto en sí |
| 3 | Control de concurrencia | Riesgo Alto identificado en el PRD; debe implementarse desde el día 1 |

---

## Edge Cases — Escenarios de fallo
